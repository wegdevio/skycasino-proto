...
(function (GameState) {
     ...
     */
    GameState[GameState["STATE_BANKER"] = 3] = "STATE_BANKER";
    /**
     * Scan the player card
     *
     * @generated from enum value: STATE_PLAYER = 4;
     */
    GameState[GameState["STATE_PLAYER"] = 4] = "STATE_PLAYER";
    /**
     * Scan the banker extra card
     *
     * @generated from enum value: STATE_BANKER_EXTRA = 5;
     */
    GameState[GameState["STATE_BANKER_EXTRA"] = 5] = "STATE_BANKER_EXTRA";
    /**
     * Scan the player extra card
     *
     * @generated from enum value: STATE_PLAYER_EXTRA = 6;
     */
    GameState[GameState["STATE_PLAYER_EXTRA"] = 6] = "STATE_PLAYER_EXTRA";
    /**
     * Game Ended
     *
     ...
     */
    GameState[GameState["STATE_PEEK"] = 20] = "STATE_PEEK";
    /**
     * When me for banker extra card
     *
     * @generated from enum value: STATE_PEEK_BANKER = 22;
     */
    GameState[GameState["STATE_PEEK_BANKER"] = 22] = "STATE_PEEK_BANKER";
    /**
     * When me for player extra card
     *
     * @generated from enum value: STATE_PEEK_PLAYER = 24;
     */
    GameState[GameState["STATE_PEEK_PLAYER"] = 24] = "STATE_PEEK_PLAYER";
    /**
     * Shuffle cards
     *
...
(function (WinType) {
     ...
     */
    WinType[WinType["WINBANKER"] = 1] = "WINBANKER";
    /**
     * @generated from enum value: WINPLAYER = 2;
     */
    WinType[WinType["WINPLAYER"] = 2] = "WINPLAYER";
    /**
...
export class GameStatus extends Message {
    ...
    static typeName = "games.baccarat.GameStatus";
