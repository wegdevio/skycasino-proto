...
type GameStatus struct {
	...
	SessionIdd       string      `protobuf:"bytes,1,opt,name=session_idd,json=sessionIdd,proto3" json:"session_idd,omitempty"`     // Unique tableid
	...
	FirstCard        string      `protobuf:"bytes,10,opt,name=first_card,json=firstCard,proto3" json:"first_card,omitempty"`                                           // First card
	RevealinPosition string      `protobuf:"bytes,39,opt,name=revealin_position,json=revealinPosition,proto3" json:"revealin_position,omitempty"`                      // Next position to be revealed: b1 / b2 /... / z5
	...
	BankerType       PatternType `protobuf:"varint,31,opt,name=banker_type,json=bankerType,proto3,enum=games.bullfight.PatternType" json:"banker_type,omitempty"`      // Banker pattern type
	PlayerXType      PatternType `protobuf:"varint,32,opt,name=player_x_type,json=playerXType,proto3,enum=games.bullfight.PatternType" json:"player_x_type,omitempty"` // PlayerX pattern type
	PlayerYType      PatternType `protobuf:"varint,33,opt,name=player_y_type,json=playerYType,proto3,enum=games.bullfight.PatternType" json:"player_y_type,omitempty"` // PlayerY pattern type
	PlayerZType      PatternType `protobuf:"varint,34,opt,name=player_z_type,json=playerZType,proto3,enum=games.bullfight.PatternType" json:"player_z_type,omitempty"` // PlayerZ pattern type
	PlayerXWin       WinType     `protobuf:"varint,35,opt,name=player_x_win,json=playerXWin,proto3,enum=games.bullfight.WinType" json:"player_x_win,omitempty"`        // 0  - none, 1 - player X win, 2 - banker win
	PlayerYWin       WinType     `protobuf:"varint,36,opt,name=player_y_win,json=playerYWin,proto3,enum=games.bullfight.WinType" json:"player_y_win,omitempty"`        // 0  - none, 1 - player Y win, 2 - banker win
	PlayerZWin       WinType     `protobuf:"varint,37,opt,name=player_z_win,json=playerZWin,proto3,enum=games.bullfight.WinType" json:"player_z_win,omitempty"`        // 0  - none, 1 - player Z win, 2 - banker win
...
func (x *GameStatus) GetSessionIdd() string {
	if x != nil {
		return x.SessionIdd
	}
	return ""
...
func (x *GameStatus) GetRevealinPosition() string {
	if x != nil {
		return x.RevealinPosition
	}
	return ""
}
...
var file_games_bullfight_record_proto_rawDesc = []byte{
	...
	0x94, 0x0b, 0x0a, 0x0a, 0x47, 0x61, 0x6d, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1f,
	0x0a, 0x0b, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x64, 0x12,
	...
	0x52, 0x07, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x30, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x73,
	0x2e, 0x62, 0x75, 0x6c, 0x6c, 0x66, 0x69, 0x67, 0x68, 0x74, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x53,
	...
	,
	...
	,
	...
	0x61, 0x79, 0x65, 0x72, 0x5a, 0x54, 0x79, 0x70, 0x65, 0x12, 0x3a, 0x0a, 0x0c, 0x70, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x5f, 0x78, 0x5f, 0x77, 0x69, 0x6e, 0x18, 0x23, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd9, 0x05, 0x0a, 0x06, 0x4f, 0x78, 0x42, 0x65, 0x61,
	...
	0x2e, 0x67, 0x61, 0x6d, 0x65, 0x73, 0x2e, 0x62, 0x75, 0x6c, 0x6c, 0x66, 0x69, 0x67, 0x68, 0x74,
	0x2e, 0x4f, 0x78, 0x42, 0x65, 0x61, 0x64, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69,
	...
	0x4f, 0x52, 0x4d, 0x41, 0x4c, 0x10, 0x02, 0x2a, 0xa2, 0x03, 0x0a, 0x04, 0x53, 0x74, 0x65, 0x70,
	...
	,
	...
	0x52, 0x45, 0x41, 0x53, 0x4f, 0x4e, 0x10, 0x01, 0x2a, 0xf3, 0x01, 0x0a, 0x09, 0x47, 0x61, 0x6d,
	...
	,
...
var file_games_bullfight_record_proto_depIdxs = []int32{
	...
	7,  // 1: games.bullfight.GameStatus.banker_type:type_name -> games.bullfight.PatternType
	7,  // 2: games.bullfight.GameStatus.player_x_type:type_name -> games.bullfight.PatternType
	7,  // 3: games.bullfight.GameStatus.player_y_type:type_name -> games.bullfight.PatternType
	7,  // 4: games.bullfight.GameStatus.player_z_type:type_name -> games.bullfight.PatternType
	6,  // 5: games.bullfight.GameStatus.player_x_win:type_name -> games.bullfight.WinType
	6,  // 6: games.bullfight.GameStatus.player_y_win:type_name -> games.bullfight.WinType
	6,  // 7: games.bullfight.GameStatus.player_z_win:type_name -> games.bullfight.WinType
