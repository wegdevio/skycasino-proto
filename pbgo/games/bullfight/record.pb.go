...
var file_games_bullfight_record_proto_rawDesc = []byte{
	...
	0x0a, 0x09, 0x4e, 0x4f, 0x5f, 0x52, 0x45, 0x41, 0x53, 0x4f, 0x4e, 0x10, 0x01, 0x42, 0xbd, 0x01,
	0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x73, 0x2e, 0x62, 0x75, 0x6c, 0x6c,
	0x66, 0x69, 0x67, 0x68, 0x74, 0x42, 0x0b, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x50, 0x72, 0x6f,
...
var file_games_bullfight_record_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_games_bullfight_record_proto_goTypes = []interface{}{
	(CardType)(0),         // 0: games.bullfight.CardType
	(ResourceType)(0),     // 1: games.bullfight.ResourceType
	(Step)(0),             // 2: games.bullfight.Step
	(Seat)(0),             // 3: games.bullfight.Seat
	(ResultRecordType)(0), // 4: games.bullfight.ResultRecordType
	(CancelReason)(0),     // 5: games.bullfight.CancelReason
}
