...
type BullfightBead struct {
	...
	FirstCard    string           `protobuf:"bytes,11,opt,name=first_card,json=firstCard,proto3" json:"firstCard" yaml:"firstCard" bson:"firstCard"`
	...
	WinType      string           `protobuf:"bytes,19,opt,name=win_type,json=winType,proto3" json:"winType" yaml:"winType" bson:"winType"`
...
var file_games_bullfight_record_proto_rawDesc = []byte{
	...
	0x49, 0x46, 0x59, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x02, 0x42, 0xbd, 0x01, 0x0a,
