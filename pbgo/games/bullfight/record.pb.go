...
const (
	...
	// 起始牌
	GameSeat_FISRTCARD GameSeat = 1
	// 莊家
	GameSeat_BANKER GameSeat = 2
	// 玩家1
	GameSeat_PLAYER1 GameSeat = 3
	// 玩家2
	GameSeat_PLAYER2 GameSeat = 4
	// 玩家3
	GameSeat_PLAYER3 GameSeat = 5
)
...
type BullfightBead struct {
	...
	BankerType   int32            `protobuf:"varint,12,opt,name=banker_type,json=bankerType,proto3" json:"bankerType" yaml:"bankerType" bson:"bankerType"`
...
var file_games_bullfight_record_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x5e, 0x0a, 0x0b, 0x47, 0x61, 0x6d,
	0x65, 0x53, 0x75, 0x62, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1e, 0x0a, 0x1a, 0x42, 0x55, 0x4c, 0x4c,
	...
	0x33, 0x10, 0x1b, 0x2a, 0x62, 0x0a, 0x08, 0x47, 0x61, 0x6d, 0x65, 0x53, 0x65, 0x61, 0x74, 0x12,
	0x14, 0x0a, 0x10, 0x53, 0x45, 0x41, 0x54, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46,
	0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x46, 0x49, 0x53, 0x52, 0x54, 0x43, 0x41,
	0x52, 0x44, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x42, 0x41, 0x4e, 0x4b, 0x45, 0x52, 0x10, 0x02,
	0x12, 0x0b, 0x0a, 0x07, 0x50, 0x4c, 0x41, 0x59, 0x45, 0x52, 0x31, 0x10, 0x03, 0x12, 0x0b, 0x0a,
	0x07, 0x50, 0x4c, 0x41, 0x59, 0x45, 0x52, 0x32, 0x10, 0x04, 0x12, 0x0b, 0x0a, 0x07, 0x50, 0x4c,
	0x41, 0x59, 0x45, 0x52, 0x33, 0x10, 0x05, 0x2a, 0x63, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x75, 0x6c,
	...
	0x49, 0x46, 0x59, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x02, 0x42, 0xb9, 0x01, 0x0a,
	0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x73, 0x2e, 0x62, 0x75, 0x6c, 0x6c, 0x66,
	0x69, 0x67, 0x68, 0x74, 0x42, 0x0b, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x50, 0x72, 0x6f, 0x74,
	...
	0x6d, 0x65, 0x73, 0x2f, 0x62, 0x75, 0x6c, 0x6c, 0x66, 0x69, 0x67, 0x68, 0x74, 0xa2, 0x02, 0x03,
	0x47, 0x42, 0x58, 0xaa, 0x02, 0x0f, 0x47, 0x61, 0x6d, 0x65, 0x73, 0x2e, 0x42, 0x75, 0x6c, 0x6c,
	0x66, 0x69, 0x67, 0x68, 0x74, 0xca, 0x02, 0x0f, 0x47, 0x61, 0x6d, 0x65, 0x73, 0x5c, 0x42, 0x75,
	0x6c, 0x6c, 0x66, 0x69, 0x67, 0x68, 0x74, 0xe2, 0x02, 0x1b, 0x47, 0x61, 0x6d, 0x65, 0x73, 0x5c,
	0x42, 0x75, 0x6c, 0x6c, 0x66, 0x69, 0x67, 0x68, 0x74, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x10, 0x47, 0x61, 0x6d, 0x65, 0x73, 0x3a, 0x3a, 0x42,
	0x75, 0x6c, 0x6c, 0x66, 0x69, 0x67, 0x68, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_games_bullfight_record_proto_goTypes = []interface{}{
	...
	(GameSeat)(0),         // 3: games.bullfight.GameSeat
	(ResultRecordType)(0), // 4: games.bullfight.ResultRecordType
	(*BullfightBead)(nil), // 5: games.bullfight.BullfightBead
	nil,                   // 6: games.bullfight.BullfightBead.StatisticsEntry
}
var file_games_bullfight_record_proto_depIdxs = []int32{
	6, // 0: games.bullfight.BullfightBead.statistics:type_name -> games.bullfight.BullfightBead.StatisticsEntry
