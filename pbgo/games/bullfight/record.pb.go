...
type BullfightBead struct {
	...
	PlayerYCards []string         `protobuf:"bytes,9,rep,name=player_y_cards,json=playerYCards,proto3" json:"playerYCards" yaml:"playerYCards" bson:"playerYCards"`
	PlayerZCards []string         `protobuf:"bytes,10,rep,name=player_z_cards,json=playerZCards,proto3" json:"playerZCards" yaml:"playerZCards" bson:"playerZCards"`
	...
	PlayerZWin   bool             `protobuf:"varint,18,opt,name=player_z_win,json=playerZWin,proto3" json:"playerZWin" yaml:"playerZWin" bson:"playerZWin"`
