...
type FantanBead struct {
	...
	Odd        int32            `protobuf:"varint,9,opt,name=odd,proto3" json:"odd" yaml:"odd" bson:"odd"`
...
var file_games_fantan_record_proto_rawDesc = []byte{
	...
	0x57, 0x4c, 0x10, 0x10, 0x2a, 0x63, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x65,
	...
	0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x02, 0x42, 0xab, 0x01, 0x0a, 0x10, 0x63, 0x6f,
...
var file_games_fantan_record_proto_goTypes = []interface{}{
	...
	(*FantanBead)(nil),    // 3: games.fantan.FantanBead
	nil,                   // 4: games.fantan.FantanBead.StatisticsEntry
}
var file_games_fantan_record_proto_depIdxs = []int32{
	4, // 0: games.fantan.FantanBead.statistics:type_name -> games.fantan.FantanBead.StatisticsEntry
