...
type Tag struct {
	...
	// 值
	Value string `protobuf:"bytes,2,opt,name=value,proto3" json:"value" bson:"value" yaml:"value"`
}
...
type RoundRecord struct {
	...
	// 桌代碼
	TableCode string `protobuf:"bytes,6,opt,name=table_code,json=tableCode,proto3" json:"tableCode" yaml:"tableCode" bson:"tableCode"`
	// 排班代碼
	...
	// 局代碼
	RoundCode string `protobuf:"bytes,9,opt,name=round_code,json=roundCode,proto3" json:"roundCode" bson:"roundCode" yaml:"roundCode"`
	// 使用洗牌代碼
	...
	// 座位組
	// key: SeatCode, value: Seat
	Seats map[int32]*Seat `protobuf:"bytes,13,rep,name=seats,proto3" json:"seats" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"seats,omitempty" yaml:"seats"`
	// 玩家入座
	// key: SeatCode, value: 玩家code。
	Players map[int32]string `protobuf:"bytes,14,rep,name=players,proto3" json:"players" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"players,omitempty" yaml:"players"`
	// 標籤
	Tags []*Tag `protobuf:"bytes,15,rep,name=tags,proto3" json:"tags" bson:"tags" yaml:"tags"`
	// 歷程
	Process []*Step `protobuf:"bytes,16,rep,name=process,proto3" json:"process" bson:"process,omitempty" yaml:"process"`
	// 判讀
	Results []*Result `protobuf:"bytes,17,rep,name=results,proto3" json:"results" bson:"results,omitempty" yaml:"results"`
	// 結束
	...
	// 附加媒體
	Mideas map[string]*URLMedia `protobuf:"bytes,24,rep,name=mideas,proto3" json:"mideas" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"mideas" yaml:"mideas"`
	// 下注狀態
	BetStep BetStep `protobuf:"varint,25,opt,name=bet_step,json=betStep,proto3,enum=recorder.BetStep" json:"betStep" bson:"betStep" yaml:"betStep"`
}
...
func (x *RoundRecord) GetTags() []*Tag {
	if x != nil {
		return x.Tags
	}
	return nil
...
type ShiftRecord struct {
	...
	ShiftCode string `protobuf:"bytes,7,opt,name=shift_code,json=shiftCode,proto3" json:"shiftCode" bson:"shiftCode" yaml:"shiftCode"`
	// 開始時間
	TsStart *timestamppb.Timestamp `protobuf:"bytes,12,opt,name=ts_start,json=tsStart,proto3" json:"tsStart" yaml:"tsStart" bson:"tsStart"`
	// 標籤
	Tags []*Tag `protobuf:"bytes,15,rep,name=tags,proto3" json:"tags" bson:"tags" yaml:"tags"`
	// 執行遊戲局
	RoundCodes []string `protobuf:"bytes,9,rep,name=round_codes,json=roundCodes,proto3" json:"roundCodes" bson:"roundCodes" yaml:"roundCodes"`
	// 洗牌
	ShoeCodes []string `protobuf:"bytes,10,rep,name=shoe_codes,json=shoeCodes,proto3" json:"shoeCodes" bson:"shoeCodes" yaml:"shoeCodes"`
	// 結束
	IsEnd bool `protobuf:"varint,18,opt,name=is_end,json=isEnd,proto3" json:"isEnd" yaml:"isEnd" bson:"isEnd"`
	// 結束時間
	TsEnd *timestamppb.Timestamp `protobuf:"bytes,19,opt,name=ts_end,json=tsEnd,proto3" json:"tsEnd" bson:"tsEnd,omitempty" yaml:"tsEnd"`
...
func (x *ShiftRecord) GetTags() []*Tag {
	if x != nil {
		return x.Tags
	}
	return nil
...
var file_recorder_record_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x74, 0x5f, 0x73, 0x65, 0x61, 0x74, 0x22, 0xe4, 0x03, 0x0a, 0x04, 0x53, 0x74, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x45, 0x6e, 0x64, 0x12, 0x39, 0x0a, 0x06, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x18, 0x14,
	...
	,
	...
	0x65, 0x61, 0x73, 0x12, 0x2c, 0x0a, 0x08, 0x62, 0x65, 0x74, 0x5f, 0x73, 0x74, 0x65, 0x70, 0x18,
	0x19, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x2e, 0x42, 0x65, 0x74, 0x53, 0x74, 0x65, 0x70, 0x52, 0x07, 0x62, 0x65, 0x74, 0x53, 0x74, 0x65,
	0x70, 0x1a, 0x48, 0x0a, 0x0a, 0x53, 0x65, 0x61, 0x74, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4d, 0x0a, 0x0b, 0x4d, 0x69, 0x64, 0x65, 0x61,
	...
	0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x63, 0x75, 0x74, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x22, 0xce,
	...
	0x70, 0x74, 0x79, 0x22, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x67, 0x61, 0x6d, 0x65,
	...
	0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x61,
	0x62, 0x6c, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x68, 0x69, 0x66, 0x74,
	0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x68, 0x69,
	...
	,
	...
	0x74, 0x73, 0x45, 0x6e, 0x64, 0x1a, 0x48, 0x0a, 0x0a, 0x44, 0x65, 0x63, 0x6b, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x24, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e,
	0x44, 0x65, 0x63, 0x6b, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22,
	0xf7, 0x03, 0x0a, 0x0b, 0x53, 0x68, 0x69, 0x66, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12,
	...
	0x67, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x63, 0x6f, 0x64, 0x65,
	0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x43, 0x6f,
	0x64, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x68, 0x6f, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65,
	0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x73, 0x68, 0x6f, 0x65, 0x43, 0x6f, 0x64,
	0x65, 0x73, 0x12, 0x15, 0x0a, 0x06, 0x69, 0x73, 0x5f, 0x65, 0x6e, 0x64, 0x18, 0x12, 0x20, 0x01,
	...
	,
	...
	0x4f, 0x5f, 0x4d, 0x4f, 0x52, 0x45, 0x5f, 0x42, 0x45, 0x54, 0x10, 0x02, 0x42, 0x92, 0x01, 0x0a,
...
var file_recorder_record_proto_goTypes = []interface{}{
	...
	(*Tag)(nil),                   // 9: recorder.Tag
	(*RoundRecord)(nil),           // 10: recorder.RoundRecord
	(*Deck)(nil),                  // 11: recorder.Deck
	(*ShoeRecord)(nil),            // 12: recorder.ShoeRecord
	(*ShiftRecord)(nil),           // 13: recorder.ShiftRecord
	nil,                           // 14: recorder.StepAction.CardsEntry
	nil,                           // 15: recorder.StepAction.ScoresEntry
	nil,                           // 16: recorder.Seat.CardsEntry
	nil,                           // 17: recorder.Seat.ScoresEntry
	nil,                           // 18: recorder.Result.SeatsEntry
...
var file_recorder_record_proto_depIdxs = []int32{
	...
	14, // 2: recorder.StepAction.cards:type_name -> recorder.StepAction.CardsEntry
	15, // 3: recorder.StepAction.scores:type_name -> recorder.StepAction.ScoresEntry
	...
	16, // 8: recorder.Seat.cards:type_name -> recorder.Seat.CardsEntry
	17, // 9: recorder.Seat.scores:type_name -> recorder.Seat.ScoresEntry
	24, // 10: recorder.Result.timestamp:type_name -> google.protobuf.Timestamp
	18, // 11: recorder.Result.seats:type_name -> recorder.Result.SeatsEntry
	24, // 12: recorder.RoundRecord.ts_start:type_name -> google.protobuf.Timestamp
	19, // 13: recorder.RoundRecord.seats:type_name -> recorder.RoundRecord.SeatsEntry
	20, // 14: recorder.RoundRecord.players:type_name -> recorder.RoundRecord.PlayersEntry
	9,  // 15: recorder.RoundRecord.tags:type_name -> recorder.Tag
	5,  // 16: recorder.RoundRecord.process:type_name -> recorder.Step
	7,  // 17: recorder.RoundRecord.results:type_name -> recorder.Result
	24, // 18: recorder.RoundRecord.ts_end:type_name -> google.protobuf.Timestamp
	21, // 19: recorder.RoundRecord.mideas:type_name -> recorder.RoundRecord.MideasEntry
	1,  // 20: recorder.RoundRecord.bet_step:type_name -> recorder.BetStep
	3,  // 21: recorder.Deck.cards:type_name -> recorder.CardList
	22, // 22: recorder.ShoeRecord.decks:type_name -> recorder.ShoeRecord.DecksEntry
	24, // 23: recorder.ShoeRecord.ts_start:type_name -> google.protobuf.Timestamp
	24, // 24: recorder.ShoeRecord.ts_end:type_name -> google.protobuf.Timestamp
	24, // 25: recorder.ShiftRecord.ts_start:type_name -> google.protobuf.Timestamp
	9,  // 26: recorder.ShiftRecord.tags:type_name -> recorder.Tag
	24, // 27: recorder.ShiftRecord.ts_end:type_name -> google.protobuf.Timestamp
	...
	6,  // 30: recorder.Result.SeatsEntry.value:type_name -> recorder.Seat
	6,  // 31: recorder.RoundRecord.SeatsEntry.value:type_name -> recorder.Seat
	8,  // 32: recorder.RoundRecord.MideasEntry.value:type_name -> recorder.URLMedia
	11, // 33: recorder.ShoeRecord.DecksEntry.value:type_name -> recorder.Deck
...
func file_recorder_record_proto_init() {
	...
	file_recorder_record_proto_msgTypes[9].OneofWrappers = []interface{}{}
	type x struct{}
