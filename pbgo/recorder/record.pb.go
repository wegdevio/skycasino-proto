...
type RoundRecord struct {
	...
	// 排班代碼
	ShiftCode string `protobuf:"bytes,6,opt,name=shift_code,json=shiftCode,proto3" json:"shiftCode" yaml:"shiftCode" bson:"shiftCode"`
	// 此排班局數
	...
	// 使用洗牌代碼
	ShuffleCode string `protobuf:"bytes,9,opt,name=shuffle_code,json=shuffleCode,proto3" json:"shuffleCode" bson:"shuffleCode" yaml:"shuffleCode"`
	// 使用此洗牌第幾局，從1開始計算
	...
	// 開始時間
	TsStart *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=ts_start,json=tsStart,proto3" json:"tsStart" yaml:"tsStart" bson:"tsStart"`
	// 座位組
	// key: SeatCode, value: Seat
	Seats map[int32]*Seat `protobuf:"bytes,12,rep,name=seats,proto3" json:"seats" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"seats,omitempty" yaml:"seats"`
	// 玩家入座
	// key: SeatCode, value: 玩家code。
	Players map[int32]string `protobuf:"bytes,13,rep,name=players,proto3" json:"players" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"players,omitempty" yaml:"players"`
	// 標籤
	Tags map[string]string `protobuf:"bytes,14,rep,name=tags,proto3" json:"tags" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" yaml:"tags" bson:"tags,omitempty"`
	// 歷程
	Process []*Step `protobuf:"bytes,15,rep,name=process,proto3" json:"process" bson:"process,omitempty" yaml:"process"`
	// 判讀
	Results []*Result `protobuf:"bytes,16,rep,name=results,proto3" json:"results" bson:"results,omitempty" yaml:"results"`
	// 結束時間
	TsEnd *timestamppb.Timestamp `protobuf:"bytes,17,opt,name=ts_end,json=tsEnd,proto3" json:"tsEnd" bson:"tsEnd,omitempty" yaml:"tsEnd"`
	// 取消
	Cancel *bool `protobuf:"varint,18,opt,name=cancel,proto3,oneof" json:"cancel" bson:"cancel,omitempty" yaml:"cancel"`
	// 取消代碼：CancelReasonCode
	CancelCode *string `protobuf:"bytes,19,opt,name=cancel_code,json=cancelCode,proto3,oneof" json:"cancelCode" bson:"cancelCode,omitempty" yaml:"cancelCode"`
	// 取消備註
	CancelMessage *string `protobuf:"bytes,20,opt,name=cancel_message,json=cancelMessage,proto3,oneof" json:"cancelMessage" bson:"cancelMessage,omitempty" yaml:"cancelMessage"`
}
...
var file_recorder_record_proto_rawDesc = []byte{
	...
	0x5f, 0x73, 0x65, 0x61, 0x74, 0x22, 0xc0, 0x0a, 0x0a, 0x0b, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x52,
	...
	,
	...
	0x12, 0x53, 0x0a, 0x05, 0x73, 0x65, 0x61, 0x74, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x65,
	...
	0x72, 0x73, 0x12, 0x4f, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b,
	...
	0x79, 0x42, 0x1a, 0x9a, 0x84, 0x9e, 0x03, 0x15, 0x62, 0x73, 0x6f, 0x6e, 0x3a, 0x22, 0x74, 0x61,
	0x67, 0x73, 0x2c, 0x6f, 0x6d, 0x69, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x52, 0x04, 0x74,
	0x61, 0x67, 0x73, 0x12, 0x47, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x18, 0x0f,
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e,
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x4e, 0x0a, 0x06, 0x74, 0x73, 0x5f, 0x65, 0x6e,
	...
	0x6c, 0x18, 0x12, 0x20, 0x01, 0x28, 0x08, 0x42, 0x1c, 0x9a, 0x84, 0x9e, 0x03, 0x17, 0x62, 0x73,
	...
	0x65, 0x18, 0x13, 0x20, 0x01, 0x28, 0x09, 0x42, 0x20, 0x9a, 0x84, 0x9e, 0x03, 0x1b, 0x62, 0x73,
	...
	0x6e, 0x63, 0x65, 0x6c, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x14, 0x20, 0x01,
	...
	0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x88, 0x01, 0x01, 0x1a, 0x48, 0x0a, 0x0a, 0x53,
	...
	0x65, 0x78, 0x22, 0x87, 0x04, 0x0a, 0x0d, 0x53, 0x68, 0x75, 0x66, 0x66, 0x6c, 0x65, 0x52, 0x65,
	...
	,
	...
	0x70, 0x74, 0x79, 0x22, 0x52, 0x05, 0x74, 0x73, 0x45, 0x6e, 0x64, 0x12, 0x55, 0x0a, 0x05, 0x64,
	0x65, 0x63, 0x6b, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x72, 0x65, 0x63,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x68, 0x75, 0x66, 0x66, 0x6c, 0x65, 0x52, 0x65, 0x63,
	0x6f, 0x72, 0x64, 0x2e, 0x44, 0x65, 0x63, 0x6b, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x42, 0x1b,
	0x9a, 0x84, 0x9e, 0x03, 0x16, 0x62, 0x73, 0x6f, 0x6e, 0x3a, 0x22, 0x64, 0x65, 0x63, 0x6b, 0x73,
	0x2c, 0x6f, 0x6d, 0x69, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x52, 0x05, 0x64, 0x65, 0x63,
	...
	0x6b, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0xab, 0x01, 0x0a,
