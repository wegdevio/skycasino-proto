...
type RoundRecord struct {
	...
	// 使用此洗牌第幾局，從1開始計算
	ShuffleRound int64 `protobuf:"varint,8,opt,name=shuffle_round,json=shuffleRound,proto3" json:"shuffleRound" yaml:"shuffleRound" bson:"shuffleRound"`
	// 座位組
	// key: SeatCode, value: Seat
	...
	// 開始時間
	TsStart *timestamppb.Timestamp `protobuf:"bytes,18,opt,name=ts_start,json=tsStart,proto3" json:"tsStart" yaml:"tsStart" bson:"tsStart"`
	// 結束時間
...
type ShuffleRecord struct {
	...
	// cardList
	CardList map[int32]*CardList `protobuf:"bytes,9,rep,name=card_list,json=cardList,proto3" json:"cardList" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"cardList" yaml:"cardList"`
}
...
var file_recorder_record_proto_rawDesc = []byte{
	...
	0x22, 0xde, 0x03, 0x0a, 0x0d, 0x53, 0x68, 0x75, 0x66, 0x66, 0x6c, 0x65, 0x52, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x12, 0x29, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x19,
	0x9a, 0x84, 0x9e, 0x03, 0x14, 0x62, 0x73, 0x6f, 0x6e, 0x3a, 0x22, 0x5f, 0x69, 0x64, 0x2c, 0x6f,
	0x6d, 0x69, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a,
	0x09, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	...
	0x63, 0x61, 0x72, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32,
