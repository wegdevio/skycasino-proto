...
type Card struct {
	...
	// 明文
	PlainText string `protobuf:"bytes,4,opt,name=plain_text,json=plainText,proto3" json:"plainText" bson:"plainText" yaml:"plainText"`
	// 簽章
...
type StepAction struct {
	...
	// （可選）附加資料
	Data *anypb.Any `protobuf:"bytes,9,opt,name=data,proto3" json:"data" bson:"data" yaml:"data"`
}
...
type Step struct {
	...
	// 玩家、執行者：SeatCode
	Seat int32 `protobuf:"varint,3,opt,name=seat,proto3" json:"seat" bson:"seat" yaml:"seat"`
	// 時間戳
...
type Result struct {
	...
	Seats map[int32]*Seat `protobuf:"bytes,6,rep,name=seats,proto3" json:"seats" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"seats" yaml:"seats"`
}
...
type RoundRecord struct {
	...
	// 使用牌靴
	ShuffleCode string `protobuf:"bytes,7,opt,name=shuffle_code,json=shuffleCode,proto3" json:"shuffleCode" bson:"shuffleCode" yaml:"shuffleCode"`
	// 使用此洗牌第幾局，從1開始計算
	...
	// 歷程
	Process []*Step `protobuf:"bytes,12,rep,name=process,proto3" json:"process" bson:"process,omitempty" yaml:"process"`
	// 判讀
	Results []*Result `protobuf:"bytes,13,rep,name=results,proto3" json:"results" bson:"results,omitempty" yaml:"results"`
	// 取消
	Cancel bool `protobuf:"varint,14,opt,name=cancel,proto3" json:"cancel" bson:"cancel,omitempty" yaml:"cancel"`
	// 取消代碼：CancelReasonCode
	CancelCode string `protobuf:"bytes,15,opt,name=cancel_code,json=cancelCode,proto3" json:"cancelCode" bson:"cancelCode,omitempty" yaml:"cancelCode"`
	// 取消備註
	CancelMessage string `protobuf:"bytes,16,opt,name=cancel_message,json=cancelMessage,proto3" json:"cancelMessage" bson:"cancelMessage,omitempty" yaml:"cancelMessage"`
	// 標籤
	Tags map[string]string `protobuf:"bytes,17,rep,name=tags,proto3" json:"tags" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"tags,omitempty" yaml:"tags"`
	// 開始時間
...
type Deck struct {
	...
	// 切牌位置
	CutIndex int64 `protobuf:"varint,3,opt,name=cut_index,json=cutIndex,proto3" json:"cutIndex" bson:"cutIndex" yaml:"cutIndex"`
	// 目前位置
...
var file_recorder_record_proto_rawDesc = []byte{
	...
	0x74, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x61, 0x72, 0x64, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x61, 0x72, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x22,
	0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x72,
	...
	0x10, 0x05, 0x22, 0xc3, 0x09, 0x0a, 0x0b, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x52, 0x65, 0x63, 0x6f,
	...
	0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12,
	0x1d, 0x0a, 0x0a, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x21,
	0x0a, 0x0c, 0x73, 0x68, 0x75, 0x66, 0x66, 0x6c, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x07,
	...
	0x6e, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x73, 0x68, 0x75, 0x66, 0x66, 0x6c,
	0x65, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x53, 0x0a, 0x05, 0x73, 0x65, 0x61, 0x74, 0x73, 0x18,
	0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x65, 0x72,
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x72,
	...
	,
	...
	0x67, 0x73, 0x12, 0x35, 0x0a, 0x08, 0x74, 0x73, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x12,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x52, 0x07, 0x74, 0x73, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x4e, 0x0a, 0x06, 0x74, 0x73, 0x5f,
	...
	0x79, 0x22, 0x52, 0x05, 0x74, 0x73, 0x45, 0x6e, 0x64, 0x1a, 0x48, 0x0a, 0x0a, 0x53, 0x65, 0x61,
	...
	0x02, 0x38, 0x01, 0x1a, 0x3a, 0x0a, 0x0c, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x45, 0x6e,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x84, 0x01, 0x0a, 0x04, 0x44, 0x65, 0x63,
	...
	0x63, 0x75, 0x74, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x08, 0x63, 0x75, 0x74, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x64,
	0x65, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x22,
	0x87, 0x04, 0x0a, 0x0d, 0x53, 0x68, 0x75, 0x66, 0x66, 0x6c, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72,
	...
	,
	...
	0x22, 0x52, 0x05, 0x74, 0x73, 0x45, 0x6e, 0x64, 0x12, 0x55, 0x0a, 0x05, 0x64, 0x65, 0x63, 0x6b,
	0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x2e, 0x53, 0x68, 0x75, 0x66, 0x66, 0x6c, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x2e, 0x44, 0x65, 0x63, 0x6b, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x42, 0x1b, 0x9a, 0x84, 0x9e,
	0x03, 0x16, 0x62, 0x73, 0x6f, 0x6e, 0x3a, 0x22, 0x64, 0x65, 0x63, 0x6b, 0x73, 0x2c, 0x6f, 0x6d,
	0x69, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x52, 0x05, 0x64, 0x65, 0x63, 0x6b, 0x73, 0x1a,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0xab, 0x01, 0x0a, 0x0e, 0x53, 0x74,
	...
	0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x0a, 0x42, 0x92, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_recorder_record_proto_depIdxs = []int32{
	...
	10, // 1: recorder.StepAction.cards:type_name -> recorder.StepAction.CardsEntry
	11, // 2: recorder.StepAction.scores:type_name -> recorder.StepAction.ScoresEntry
	...
	15, // 11: recorder.RoundRecord.seats:type_name -> recorder.RoundRecord.SeatsEntry
	16, // 12: recorder.RoundRecord.players:type_name -> recorder.RoundRecord.PlayersEntry
	4,  // 13: recorder.RoundRecord.process:type_name -> recorder.Step
	6,  // 14: recorder.RoundRecord.results:type_name -> recorder.Result
	17, // 15: recorder.RoundRecord.tags:type_name -> recorder.RoundRecord.TagsEntry
	20, // 16: recorder.RoundRecord.ts_start:type_name -> google.protobuf.Timestamp
