...
// @generated from file threecards/record.proto (package threecards, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * 使用卡牌種類
 *
 * @generated from enum threecards.CardType
 */
...
proto3.util.setEnumType(CardType, "threecards.CardType", [
  { no: 0, name: "CARD_TYPE_UNSPECIFIED" },
  { no: 1, name: "POKER" },
]);

/**
 * @generated from enum threecards.ResourceType
 */
...
proto3.util.setEnumType(ResourceType, "threecards.ResourceType", [
 ...
 *
 * @generated from enum threecards.Step
 */
export enum Step {
  /**
   * 未指定
...
proto3.util.setEnumType(Step, "threecards.Step", [
 ...
 * 座位功能代碼
 *
 * @generated from enum threecards.Seat
 */
export enum Seat {
  /**
   * 未指定
...
proto3.util.setEnumType(Seat, "threecards.Seat", [
 ...
 * 結果紀錄類型代碼
 *
 * @generated from enum threecards.ResultRecordType
 */
...
proto3.util.setEnumType(ResultRecordType, "threecards.ResultRecordType", [
 ...
 * 取消原因
 *
 * @generated from enum threecards.CancelReason
 */
...
proto3.util.setEnumType(CancelReason, "threecards.CancelReason", [
