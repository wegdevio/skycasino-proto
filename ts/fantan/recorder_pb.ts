...
// @generated from file fantan/recorder.proto (package fantan, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * 使用卡牌種類
 *
 * @generated from enum fantan.CardType
 */
...
proto3.util.setEnumType(CardType, "fantan.CardType", [
  { no: 0, name: "CARD_TYPE_UNSPECIFIED" },
  { no: 1, name: "CARD_TYPE_INT" },
]);

/**
 * @generated from enum fantan.ResourceType
 */
...
proto3.util.setEnumType(ResourceType, "fantan.ResourceType", [
 ...
 *
 * @generated from enum fantan.Step
 */
export enum Step {
  /**
   * 未指定
...
proto3.util.setEnumType(Step, "fantan.Step", [
 ...
 * 座位功能代碼
 *
 * @generated from enum fantan.Seat
 */
export enum Seat {
  /**
   * 未指定
...
proto3.util.setEnumType(Seat, "fantan.Seat", [
 ...
 * 結果紀錄類型代碼
 *
 * @generated from enum fantan.ResultRecordType
 */
...
proto3.util.setEnumType(ResultRecordType, "fantan.ResultRecordType", [
