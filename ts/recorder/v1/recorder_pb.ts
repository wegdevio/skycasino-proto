...
// @generated from file recorder/v1/recorder.proto (package recorder.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message recorder.v1.RecordResponse
 */
export class RecordResponse extends Message<RecordResponse> {
  ...
  static readonly typeName = "recorder.v1.RecordResponse";
...
/**
 * @generated from message recorder.v1.RecordShuffleRequest
 */
export class RecordShuffleRequest extends Message<RecordShuffleRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.RecordShuffleRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message recorder.v1.RecordRoundStartRequest
 */
export class RecordRoundStartRequest extends Message<RecordRoundStartRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.RecordRoundStartRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 2, name: "game_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "table_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message recorder.v1.RecordRoundStepsRequest
 */
export class RecordRoundStepsRequest extends Message<RecordRoundStepsRequest> {
   ...
   * 步驟
   *
   * @generated from field: repeated recorder.v1.Step steps = 5;
   */
  steps: Step[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.RecordRoundStepsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "record_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "game_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "table_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message recorder.v1.RecordRoundResultsRequest
 */
export class RecordRoundResultsRequest extends Message<RecordRoundResultsRequest> {
   ...
   * 判讀結果
   *
   * @generated from field: repeated recorder.v1.Result results = 5;
   */
  results: Result[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.RecordRoundResultsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "record_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "game_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "table_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message recorder.v1.RecordRoundCancelRequest
 */
export class RecordRoundCancelRequest extends Message<RecordRoundCancelRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.RecordRoundCancelRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "record_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "game_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "table_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message recorder.v1.RecordRoundFinishRequest
 */
export class RecordRoundFinishRequest extends Message<RecordRoundFinishRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.RecordRoundFinishRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "record_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "game_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "table_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
