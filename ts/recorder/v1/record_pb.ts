...
// @generated from file recorder/v1/record.proto (package recorder.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * 動作類型
 *
 * @generated from enum recorder.v1.StepActionType
 */
...
proto3.util.setEnumType(StepActionType, "recorder.v1.StepActionType", [
 ...
 * 卡牌，代表在此局中使用的各類物品
 *
 * @generated from message recorder.v1.Card
 */
export class Card extends Message<Card> {
  ...
  static readonly typeName = "recorder.v1.Card";
 ...
 * 卡牌列表
 *
 * @generated from message recorder.v1.CardList
 */
export class CardList extends Message<CardList> {
  /**
   * @generated from field: repeated recorder.v1.Card list = 1;
   */
  list: Card[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.CardList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * 執行動作：對某些資源進行增、刪、移轉
 *
 * @generated from message recorder.v1.StepAction
 */
export class StepAction extends Message<StepAction> {
   ...
   *
   * @generated from field: map<int64, recorder.v1.CardList> cards = 6;
   */
   ...
   * 動作類型
   *
   * @generated from field: recorder.v1.StepActionType type = 8;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.StepAction";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * 遊戲步驟
 *
 * @generated from message recorder.v1.Step
 */
export class Step extends Message<Step> {
   ...
   * 執行動作
   *
   * @generated from field: repeated recorder.v1.StepAction actions = 6;
   */
  actions: StepAction[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.Step";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "code", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
 ...
 * 座位
 *
 * @generated from message recorder.v1.Seats
 */
export class Seats extends Message<Seats> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.Seats";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "code", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 6, name: "cards", kind: "map", K: 3 /* ScalarType.INT64 */, V: {kind: "message", T: CardList} },
    { no: 7, name: "scores", kind: "map", K: 3 /* ScalarType.INT64 */, V: {kind: "scalar", T: 3 /* ScalarType.INT64 */} },
 ...
 * 記錄各座位狀態
 *
 * @generated from message recorder.v1.Result
 */
export class Result extends Message<Result> {
   ...
   *
   * @generated from field: map<int64, recorder.v1.Seats> seats = 6;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.Result";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "code", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
 ...
 * 紀錄
 *
 * @generated from message recorder.v1.RoundRecord
 */
export class RoundRecord extends Message<RoundRecord> {
   ...
   * key: SeatCode, value: Seat
   *
   * @generated from field: map<int64, recorder.v1.Seats> seats = 8;
   */
  seats: { [key: string]: Seats } = {};
   ...
   * 歷程
   *
   * @generated from field: repeated recorder.v1.Step process = 10;
   */
  process: Step[] = [];
   ...
   * 判讀
   *
   * @generated from field: repeated recorder.v1.Result results = 11;
   */
  results: Result[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recorder.v1.RoundRecord";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
