...
// @generated from file sicbo/recorder.proto (package sicbo, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * 使用卡牌種類
 *
 * @generated from enum sicbo.CardType
 */
...
proto3.util.setEnumType(CardType, "sicbo.CardType", [
  { no: 0, name: "CARD_TYPE_UNSPECIFIED" },
  { no: 1, name: "DICE" },
]);

/**
 * @generated from enum sicbo.ResourceType
 */
...
proto3.util.setEnumType(ResourceType, "sicbo.ResourceType", [
 ...
 *
 * @generated from enum sicbo.Step
 */
export enum Step {
  /**
   * 未指定
...
proto3.util.setEnumType(Step, "sicbo.Step", [
 ...
 * 座位功能代碼
 *
 * @generated from enum sicbo.Seat
 */
export enum Seat {
  /**
   * 未指定
...
proto3.util.setEnumType(Seat, "sicbo.Seat", [
 ...
 * 結果紀錄類型代碼
 *
 * @generated from enum sicbo.ResultRecordType
 */
...
proto3.util.setEnumType(ResultRecordType, "sicbo.ResultRecordType", [
